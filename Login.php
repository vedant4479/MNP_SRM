...
<body background="4.jpg" class="body_deg">
	<nav>
		<label class="logo">Easy Results</label>
		<ul>
			<li><a href="http://127.0.0.1/StudentResultManagement/index.php" class="btn btn-success">Home</a></li>
	...
	<center>
		...
		<form action="login_check.php" method="POST" class="reg_form">
			<div class="adm_int">
				<label class="label_txt">User ID</label>
				<input class="input_des" type="text" name="username">
			</div>
			<div class="adm_int">
